...
Вам будет необходимо изменить каталог сборки проекта. 
Для этого необходимо в Qt Creator зайти во вкладку Проекты (Projects) находящуюся слева.
Затем у опции "Каталог сборки" указать папку, где будет находиться скомпиллированный файл приложения.
