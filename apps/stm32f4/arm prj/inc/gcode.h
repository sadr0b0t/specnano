...
extern  void    catchError(int, int, char*);
extern  void    GCommands();
extern  void    MCommands();

/* G-commands handler delegates */
extern int (*handler_g01)(int*, double, double, double, double);
extern int (*handler_g02)(int*, double, double, double, double, double);
extern int (*handler_g03)(int*, double, double, double, double, double);

/* Result handler delegate for all g-commands */
extern int (*handler_gcommand_result)(double dx, double dy, double dz, double f);
